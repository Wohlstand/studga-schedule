...
<form method="get" action="/d/full">
	<table style="width: 100%; border-collapse: collapse">
		...
		<tr>
			...
			<?php
			while(($lec_a = mysqlold_fetch_array($lec_q)) != NULL)
			{
				$IsEmptyLector = 0;
				$old_schedule = 0;
				...
				if( intval(mysqlold_result(mysqlold_query("SELECT count(*) FROM schedule__maindata WHERE id_day=".$daycounts['id_day']." AND id_lector = ".$lec_a['id_lector'].";"), 0)) != 0)
				{
					$old_schedule = 0;
				}
				else
