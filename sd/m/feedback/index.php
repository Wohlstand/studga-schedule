...
<table style="margin: auto auto; width: 95%; border-collapse: collapse">
	<tr>
		...
		<form action="sendmail.php" method="post"><div>
			<br/>Форма связи с системным администратором:<br/></div>
			<div>
			<table style="width: 100%; border-collapse: collapse">
				<tr>
					<td style="padding: 0px; width: 100%; text-align: left" valign="top">Ваше имя:<br/>
				...
				<tr>
					<td style="padding: 0px; width: 100%; text-align: left" valign="top">Ваш электронный адрес<br/>
					<input <?php if (($error[2]=="1")||($error[3]=="1")) echo "class='errorfield '";?>name="mailfrom" style="width: 100%" type="text" value="<?=((!empty($_GET['formdata']))?htmlspecialchars(base64_decode($formfields[1])):"")?>"/></td>
				</tr>
				<tr>
					<td style="padding: 0px; width: 100%; text-align: left" valign="top">Ваше сообщение<br/>
