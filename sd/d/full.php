...
$counter = 1;
$time = strtotime($daycounts['daystart']);

while($time<strtotime($daycounts['dayend']))
{
////////////////////////////////////////////////////////////////////////БОЛЬШОЙ ЦИКЛ///////////////////////////////////////////////////////////
	...
	//-------------------------------------------ЕСЛИ СВЕЖЕЕ-------------------------------------------------------------------
		...
		if((date('Y-m-d', $time)==date('Y-m-d'))||( (strtotime(date('Y-m-d'))<strtotime($daycounts['daystart'])) && ($counter == 1) ))
		{
			if($OldCounter==0)
			{
