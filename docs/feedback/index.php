...
<table align="center" cellpadding="0" style="width: 700; border-collapse: collapse">
	<tr>
		...
		<form  action="sendmail.php" method="post">
			<br>Форма связи с системным администратором:<br>
			<div class="loginpannel shedow">
			<table cellpadding="0" style="width: 100%; border-collapse: collapse" cellspacing="4">
				<tr>
					<td style="width: 213px; text-align: right" valign="top">Ваше имя</td>
					<td>
				...
				<tr>
					<td style="width: 213px; text-align: right" valign="top">Ваше сообщение</td>
...
<?php require_once $sys_inc."html-footer.php"; ?>
